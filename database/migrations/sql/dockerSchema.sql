...
COPY questions (id, product_id, body, epoch, asker_name, asker_email, reported, helpful) FROM '/var/lib/postgresql/csvData/questions.csv' Delimiter ',' csv header;
...
COPY answers (id, question_id, body, epoch, answerer_name, answerer_email, reported, helpful) FROM '/var/lib/postgresql/csvData/answers.csv' Delimiter ',' csv header;
...
COPY photos FROM '/var/lib/postgresql/csvData/photos.csv' Delimiter ',' csv header;